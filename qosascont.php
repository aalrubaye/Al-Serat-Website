...
<table width="380" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
	<td width="126"  >&nbsp;</td>
	<td align="center" class="font11" background="pic/titrb.gif" width="128" height="23" valign="middle"> قصص وعبر</td>
   	<td width="126" >&nbsp;</td>
  </tr>
...
$space = "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
		...
		$perpage=5;
		$pquery=mysql_query("SELECT count('id') from maintable WHERE part='qosas'");
		$pages = Ceil(mysql_result($pquery,0)/$perpage);
		$page= (isset($_GET['page'])) ? (int)$_GET['page'] : 1;
		$start = ($page -1)*$perpage;

		$result = mysql_query("SELECT * FROM maintable WHERE part='qosas' ORDER BY id DESC LIMIT $start, $perpage");
